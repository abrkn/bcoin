...
class TX {
  ...
  fromReader(br) {
    ...
    const spam = (..._) => true && TX.spam && console.log('SPAM', ..._);
  ...
  writeWitness(bw, allowWitness = true) {
    const spam = (..._) => false && TX.spam && console.log('SPAM', ..._);
    ...
    spam('dem flags do', flags);

    // TODO: Terrible naming. Maybe rename to writeAsNormal or something to that effect
    if (allowWitness && flags) {
